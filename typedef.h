...
#define max32_if_true(eval)  ~(Max_u32 + (u32)(eval))
#define max8_if_true(eval)   ~(Max_u8  +  (u8)(eval))
#define max32_if_false(eval)  (Max_u32 + (u32)(eval))
#define max8_if_false(eval)   (Max_u8  +  (u8)(eval))
